...
<div class="container p-5">
    <x-adminlte-card title="Registrar Fornecedor" theme="light" theme-mode="full" class="elevation-3 text-black"
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    label="Informe aqui o cnj do Fornecedor:" data-mask="00.000.000-0000-00" value="{{ $fornecedor->cnpj }}" >
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-dark">
        ...
        <div class="row border-bottom">
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    label="Informe aqui o CEP do Fornecedor" data-mask="00000-000" icon="fas fa-bed" value="{{  $endereco->cep }}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-dark">
