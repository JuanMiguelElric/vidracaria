        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    label="Informe aqui o nome do funcionario" icon="fas fa-bed" value="{{ $funcionario->nome }}" >
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    label="Informe aqui o cpf do funcionario:" data-mask="999.999.999-99" value="{{ $funcionario->cpf }}" >
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-dark">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="dataNascimento" value="{{$funcionario->dataNascimento}}"  />
                </div>
            ...
            <div class="row  border-bottom pt-3">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        label="Informe aqui o email do funcionario:(caso houver)" icon="fas fa-envelope" value="{{$funcionario->email}}" >
